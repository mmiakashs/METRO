...
class DatasetPropGen:
    ...
    def get_uva_dar_prop(self, hparams):
        ...
        modality_prop[config.inside_modality_tag]['seq_max_len'] = 100
        ...
        modality_prop[config.outside_modality_tag]['seq_max_len'] = 100
        ...
        for modality in hparams.modalities:
            ...
            if modality == config.gaze_modality_tag:
                ...
                # if modality == config.gaze_modality_tag:
                #     modality_prop[modality]['num_joints'] = config.utd_mhad_num_joints
                #     modality_prop[modality]['num_attribs'] = config.utd_mhad_num_joint_attribs
                # elif modality == config.gaze_modality_tag:
                #     modality_prop[modality]['num_joints'] = config.utd_mhad_num_inertials
                #     modality_prop[modality]['num_attribs'] = config.utd_mhad_num_inertials_attribs
